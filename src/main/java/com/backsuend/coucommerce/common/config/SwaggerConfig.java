...
@OpenAPIDefinition(servers = {@Server(url = "http://localhost:8080", description = "로컬 서버")})
@Configuration
@SecurityScheme(
    name = "Authorization",
...
public class SwaggerConfig {
  ...
  private Info apiInfo() {
    return new Info().title("Cou-commerce Swagger").description("모든 REST API").version("1.0.0");
  }
}
